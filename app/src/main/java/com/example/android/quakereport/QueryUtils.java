...
//    private static JSONObject earthquakesReader;
//
//    {
//        try {
//            earthquakesReader = new JSONObject(SAMPLE_JSON_RESPONSE);
...
//    }
    ...
    public static ArrayList<Word> extractEarthquakes(){
        ...
        try {
            JSONObject earthquakesReader = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray features = earthquakesReader.getJSONArray("features");
            ...
            for(int i = 0; i<features.length(); i++){
                ...
                earthquakes.add(new Word(magnitude, location, time, url));
    ...
    private static JSONArray getFeatures(JSONArray features) {
        return features;
    }
